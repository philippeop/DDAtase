...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	 12,  0, 20,165, 9,  1,  7,  4,  4,  1,  0,  0, 28,  0,
	&mdeath::normal,	&mattack::none, "\
...
FLAGS(MF_SEES, MF_HEARS, MF_SMELLS, MF_ANIMAL, MF_WARM, MF_FUR, MF_BLEED, MF_VIS20, MF_BONES);
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	 12,  0, 20,180, 10,  1,  7,  4,  4,  0,  0,  0, 15,  5,
	&mdeath::normal,	&mattack::leap, "\
A vicious and fast hunter."
);
FLAGS(MF_SEES, MF_HEARS, MF_SMELLS, MF_ANIMAL, MF_WARM, MF_FUR, MF_HIT_AND_RUN, MF_KEENNOSE, MF_BLEED, MF_VIS40, MF_BONES);
...
FLAGS(MF_SEES, MF_HEARS, MF_SMELLS, MF_ANIMAL, MF_WARM, MF_FLIES, MF_VIS30, MF_BONES);
CATEGORIES(MC_WILDLIFE);

// DOMESICATED ANIMALS
mon("dog",	species_mammal, 'd',	c_white,	MS_SMALL,	FLESH,
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  0,  -30, 15,140, 5,  1,  7,  4,  3,  0,  0,  0, 15,  0,
	&mdeath::normal,	&mattack::none, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	 22,  5, 60,150,  6,  1,  3,  0,  7,  0,  0,-40, 5, 0,
	&mdeath::normal,	&mattack::none, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  3,100,100, 50,  4,  2,  4,  1,  1,  0,  0, 40, 50,  10,
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  3,100,100, 50,  5,  2,  4,  2,  1,  0,  0, 40, 50,  10,
	&mdeath::normal,	&mattack::bite, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  3,100,100,100, 10,  2,  4,  2,  4,  0,  0, 45, 40,  20,
	&mdeath::normal,	&mattack::bite, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	25,100,100,100,  9,  4,  4,  0,  0,  6,  3, 60, 80,  10,
	&mdeath::normal,	&mattack::bite, "\
...
//	 dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  3,100,100, 50, 3,  1,  7,  1,  2,  0, 15,  0, 40, 20,
	&mdeath::normal,	&mattack::bite, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
      3,100,100, 75,  15,  1,  7,  0,  5,  0,  0, 50, 35, 8,
	&mdeath::normal,	&mattack::bite, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
     20,100,100, 80, 8,  2,  4,  2,  0,  8, 16, 60,100, 10,
	&mdeath::normal,	&mattack::bite, "\
...
//	dif agr mor spd msk mdi m## cut dge bsh cut itm  HP special freq
	  3,100,100, 70, 8,  1,  3,  2,  2,  0,  0, 10, 25,  0,
	&mdeath::normal,	&mattack::none, "\
...
FLAGS(MF_SEES, MF_HEARS, MF_SMELLS, MF_STUMBLES, MF_WARM, MF_BASHES, MF_BLEED,
      MF_POISON, MF_GUILT, MF_NO_BREATHE, MF_HIT_AND_RUN, MF_VIS20);
CATEGORIES(MC_CLASSIC);
