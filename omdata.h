...
// Terrain	 MIN MAX DISTANCE
{ot_anthill,	   0, 0,  10, -1, "GROUP_ANT", 10, 30, 1000, 2000, //Oddzball-No Anthills
 &omspec_place::never, 0},

{ot_spider_pit,	   0,500,  0, -1, "GROUP_NULL", 0, 0, 0, 0,
 &omspec_place::forest, 0},

{ot_slimepit,	   0,  0,  0, -1, "GROUP_GOO", 2, 10, 100, 200, //Oddzball-No Slimes
 &omspec_place::never, 0},

{ot_fungal_bloom,  0,  0,  5, -1, "GROUP_FUNGI", 600, 1200, 30, 50, //Oddzball-No Fungal
 &omspec_place::never, 0},

{ot_triffid_grove, 0,  0,  0, -1, "GROUP_TRIFFID", 800, 1300, 12, 20, //Oddzball-No Triffids
 &omspec_place::never, 0},
