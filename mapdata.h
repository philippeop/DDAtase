...
t_wall, t_concrete_v, t_concrete_h,
t_wall_metal,
...
struct ter_t {
 ...
 trap_id trap;
 ter_id base_terrain;  // what ground it stands on TILES
 unsigned long flags;// : num_t_flags;
};

// TILES
// list of terrains that walls should connect
// i.e., window, doors
const ter_id ter_omni_connect[] =
{
    t_door_c,
    t_door_b,
    t_door_o,
...
{"nothing",	        ' ', c_white,   2, tr_null, t_null,
	mfb(transparent)|mfb(diggable)},
{"empty space",     '#', c_black,   2, tr_ledge, t_hole,
	mfb(transparent)},
{"dirt",	        '.', c_brown,   2, tr_null, t_dirt,
	mfb(transparent)|mfb(diggable)|mfb(tentable)},
{"sand",	        '.', c_yellow,  2, tr_null, t_dirt,
	mfb(transparent)|mfb(diggable)|mfb(tentable)},
{"mound of dirt",   '#', c_brown,   3, tr_null, t_dirt,
	mfb(transparent)|mfb(diggable)},
{"shallow pit",	    '0', c_yellow,  8, tr_null, t_dirt,
	mfb(transparent)|mfb(diggable)},
{"pit",             '0', c_brown,  10, tr_pit, t_dirt,
	mfb(transparent)|mfb(diggable)},
{"corpse filled pit",'#', c_green,  5,  tr_null, t_dirt,
        mfb(transparent)|mfb(diggable)},
{"covered pit",     '#', c_ltred,   2, tr_null, t_dirt,
	mfb(transparent)},
{"spiked pit",      '0', c_ltred,  10, tr_spike_pit, t_dirt,
	mfb(transparent)|mfb(diggable)},
{"covered spiked pit",'#',c_ltred,  2, tr_null, t_dirt,
	mfb(transparent)},
{"rock floor",      '.', c_ltgray,  2, tr_null, t_rock_floor,
	mfb(transparent)},
{"pile of rubble",  '^', c_ltgray,  4, tr_null, t_dirt,
	mfb(transparent)|mfb(rough)|mfb(diggable)},
{"pile of ash",     '#', c_ltgray,  2, tr_null, t_dirt,
	mfb(transparent)|mfb(diggable)},
{"twisted metal",   '#', c_cyan,    5, tr_null, t_dirt,
        mfb(transparent)|mfb(rough)|mfb(sharp)|mfb(place_item)},
{"metal wreckage",  '#', c_cyan,    5, tr_null, t_dirt,
        mfb(transparent)|mfb(rough)|mfb(sharp)|mfb(place_item)},
{"grass",	        '.', c_green,   2, tr_null, t_null,
	mfb(transparent)|mfb(diggable)|mfb(tentable)},
{"metal floor",     '.', c_ltcyan,  2, tr_null, t_null,
	mfb(transparent)},
{"pavement",	    '.', c_dkgray,  2, tr_null, t_null,
	mfb(transparent)},
{"yellow pavement", '.', c_yellow,  2, tr_null, t_null,
	mfb(transparent)},
{"sidewalk",        '.', c_ltgray,  2, tr_null, t_null,
	mfb(transparent)},
{"floor",	        '.', c_cyan,    2, tr_null, t_null,
	mfb(transparent)|mfb(l_flammable)|mfb(supports_roof)|mfb(collapses)},
{"dirt floor",	    '.', c_brown,   2, tr_null, t_null,  //Dirt Floor, must have roofs!
	mfb(transparent)|mfb(diggable)|mfb(supports_roof)|mfb(collapses)},
{"hay",             '#', i_brown,   5, tr_null, t_null,
	mfb(transparent)|mfb(container)|mfb(flammable2)|mfb(collapses)},
{"metal grate",     '#', c_dkgray,  2, tr_null, t_null,
	mfb(transparent)},
{"slime",           '~', c_green,   6, tr_null, t_null,
        mfb(transparent)|mfb(container)|mfb(flammable2)|mfb(place_item)},
{"walkway",         '#', c_yellow,  2, tr_null, t_null,
	mfb(transparent)},
{"canvas wall",     '#', c_blue,    0, tr_null, t_null,
        mfb(l_flammable)|mfb(bashable)|mfb(noitem)|mfb(tentable)},
{"canvas flap",     '+', c_blue,    0, tr_null, t_null,
        mfb(l_flammable)|mfb(bashable)|mfb(noitem)|mfb(tentable)},
{"open canvas flap",'.', c_blue,    2, tr_null, t_null,
        mfb(transparent)},
{"groundsheet",     ';', c_green,   2, tr_null, t_null,
        mfb(transparent)|mfb(tentable)},
{"groundsheet",     ';', c_green,   2, tr_null, t_null,
        mfb(transparent)},
{"floor",	        '.', c_white,   2, tr_null, t_null,
...
{"half-built wall", '#', c_brown,   4, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)},
{"log wall",        '#', c_brown,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"chipped log wall",'#', c_brown,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"broken log wall", '&', c_brown,   0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)|
	mfb(supports_roof)},
{"palisade wall",        '#', c_brown,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)|mfb(transparent)},
{"palisade gate",        '+', c_ltred,    0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)|mfb(door)|mfb(transparent)},
{"open palisade gate",   '#', c_ltred,   2, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)|mfb(transparent)},
{"half-built wall",  '#', c_ltred,   4, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)},
{"wooden wall",      '#', c_ltred,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"chipped wood wall",'#', c_ltred,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"broken wood wall", '&', c_ltred,   0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)|
    mfb(supports_roof)},
{"wall",             '|', c_ltgray,  0, tr_null, t_null,
        mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
/*{"wall",             '-', c_ltgray,  0, tr_null, t_null,
        mfb(flammable)|mfb(noitem)|mfb(supports_roof)},*/
{"concrete wall",    '|', c_dkgray,  0, tr_null, t_null,
        mfb(noitem)|mfb(supports_roof)},
{"concrete wall",    '-', c_dkgray,  0, tr_null, t_null,
        mfb(noitem)|mfb(supports_roof)},
{"metal wall",       '|', c_cyan,    0, tr_null, t_null,
        mfb(noitem)|mfb(noitem)|mfb(supports_roof)},
/*{"metal wall",       '-', c_cyan,    0, tr_null, t_null,
        mfb(noitem)|mfb(noitem)|mfb(supports_roof)},*/
{"glass wall",       '|', c_ltcyan,  0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{"glass wall",       '-', c_ltcyan,  0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{"glass wall",       '|', c_ltcyan,  0, tr_null, t_null, // Alarmed
	mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
 mfb(supports_roof)},
{"glass wall",       '-', c_ltcyan,  0, tr_null, t_null, // Alarmed
	mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
 mfb(supports_roof)},
{"reinforced glass", '|', c_ltcyan,  0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{"reinforced glass", '-', c_ltcyan,  0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{"metal bars",       '"', c_ltgray,  0, tr_null, t_null,
	mfb(transparent)|mfb(noitem)},
{"closed wood door", '+', c_brown,   0, tr_null, t_null,
        mfb(bashable)|mfb(flammable2)|mfb(door)|mfb(noitem)|mfb(supports_roof)},
{"damaged wood door",'&', c_brown,   0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)|
        mfb(supports_roof)},
{"open wood door",  '\'', c_brown,   2, tr_null, t_null,
        mfb(flammable2)|mfb(transparent)|mfb(supports_roof)},
{"closed wood door", '+', c_brown,   0, tr_null, t_null,	// Actually locked
        mfb(bashable)|mfb(flammable2)|mfb(noitem)|mfb(supports_roof)},
{"closed wood door", '+', c_brown,   0, tr_null, t_null, // Locked and alarmed
	mfb(bashable)|mfb(flammable2)|mfb(alarmed)|mfb(noitem)|mfb(supports_roof)},
{"empty door frame", '.', c_brown,   2, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof)},
{"locked wire gate", '+', c_cyan,    0, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof)},
{"closed wooden gate", '+', c_brown, 3, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof) |mfb(bashable)|mfb(flammable2)},
{"open wooden gate", '.', c_brown,   2, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof) |mfb(bashable)|mfb(flammable2)},
{"closed wire gate", '+', c_cyan,    0, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof)},
{"open wire gate",   '.', c_cyan,    2, tr_null, t_null,
        mfb(transparent)|mfb(supports_roof)},
{"boarded up door",  '#', c_brown,   0, tr_null, t_null,
	mfb(bashable)|mfb(flammable2)|mfb(noitem)|mfb(supports_roof)},
{"closed metal door",'+', c_cyan,    0, tr_null, t_null,
	mfb(noitem)|mfb(supports_roof)},
{"open metal door", '\'', c_cyan,    2, tr_null, t_null,
	mfb(transparent)|mfb(supports_roof)},
{"closed metal door",'+', c_cyan,    0, tr_null, t_null, // Actually locked
	mfb(noitem)|mfb(supports_roof)},
{"closed glass door",'+', c_ltcyan,  0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(door)|mfb(noitem)|mfb(supports_roof)},
{"open glass door", '\'', c_ltcyan,  2, tr_null, t_null,
	mfb(transparent)|mfb(supports_roof)},
{"bulletin board",   '6', c_blue,    0, tr_null, t_null,
	mfb(flammable)|mfb(noitem)},
{"makeshift portcullis", '&', c_cyan,0, tr_null, t_null,
	mfb(noitem)},
{"steel compactor",  '&', c_green,   0, tr_null, t_null,
        mfb(transparent)},
{"window",	         '"', c_ltcyan,  0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)|mfb(deconstruct)}, // Plain Ol' window
{"taped window",     '"', c_dkgray,  0, tr_null, t_null,
...
{"open window",      '\'', c_ltcyan, 4, tr_null, t_null,
	mfb(transparent)|mfb(flammable)|mfb(noitem)| mfb(supports_roof)},
{"closed curtains",  '"', c_dkgray,  0, tr_null, t_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)| mfb(supports_roof)},
{"window",	         '"', c_ltcyan,  0, tr_null, t_null, // Actually alarmed
...
{"empty window",     '0', c_yellow,  8, tr_null, t_null,
	mfb(transparent)|mfb(flammable)|mfb(supports_roof)},
{"window frame",     '0', c_ltcyan,  8, tr_null, t_null,
	mfb(transparent)|mfb(sharp)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)},
{"boarded up window",'#', c_brown,   0, tr_null, t_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"solid rock",       '#', c_white,   0, tr_null, t_null,
	mfb(noitem)|mfb(supports_roof)},
{"odd fault",        '#', c_magenta, 0, tr_null, t_null,
	mfb(noitem)|mfb(supports_roof)},
{"paper wall",       '#', c_white,   0, tr_null, t_null,
	mfb(bashable)|mfb(flammable2)|mfb(noitem)},
{"tree",	         '7', c_green,   0, tr_null, t_null,
	mfb(flammable2)|mfb(noitem)|mfb(supports_roof)},
{"young tree",       '1', c_green,   4, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(noitem)},
{"apple tree",       '7', c_ltgreen, 0, tr_null, t_null,
	mfb(flammable2)|mfb(noitem)|mfb(supports_roof)},
{"underbrush",       '#', c_ltgreen, 6, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(diggable)|mfb(container)|
        mfb(flammable2)|mfb(thin_obstacle)|mfb(place_item)},
{"shrub",            '#', c_green,   8, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable2)|
        mfb(thin_obstacle)|mfb(place_item)},
{"blueberry bush",   '#', c_ltgreen,   8, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable2)|mfb(thin_obstacle)},
{"tree trunk",              '1', c_brown,   4, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(diggable)},
{"root wall",        '#', c_brown,   0, tr_null, t_null,
	mfb(noitem)|mfb(supports_roof)},
{"wax wall",         '#', c_yellow,  0, tr_null, t_null,
        mfb(flammable2)|mfb(noitem)|mfb(supports_roof)|mfb(place_item)},
{"wax floor",        '.', c_yellow,  2, tr_null, t_null,
	mfb(transparent)|mfb(l_flammable)},
{"picket fence",     '|', c_brown,   3, tr_null, t_null,
	mfb(transparent)|mfb(diggable)|mfb(flammable2)|mfb(noitem)|mfb(thin_obstacle)},
{"picket fence",     '-', c_brown,   3, tr_null, t_null,
	mfb(transparent)|mfb(diggable)|mfb(flammable2)|mfb(noitem)|mfb(thin_obstacle)},
{"chain link fence", '|', c_cyan,    0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(thin_obstacle)},
{"chain link fence", '-', c_cyan,    0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(thin_obstacle)},
{"metal post",       '#', c_cyan,    2, tr_null, t_null,
        mfb(transparent)|mfb(thin_obstacle)},
{"fence post",       '#', c_brown,   2, tr_null, t_null,
        mfb(transparent)|mfb(thin_obstacle)},
{"wire fence",       '$', c_blue,    4, tr_null, t_null,
        mfb(transparent)|mfb(thin_obstacle)},
{"barbed wire fence",'$', c_blue,    4, tr_null, t_null,
        mfb(transparent)|mfb(sharp)|mfb(thin_obstacle)},
{"rope fence",       '$', c_brown,   3, tr_null, t_null,
        mfb(transparent)|mfb(thin_obstacle)},
{"railing",          '|', c_yellow,  3, tr_null, t_null,
	mfb(transparent)|mfb(noitem)|mfb(thin_obstacle)},
{"railing",          '-', c_yellow,  3, tr_null, t_null,
	mfb(transparent)|mfb(noitem)|mfb(thin_obstacle)},
{"marloss bush",     '1', c_dkgray,  0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable2)},
{"fungal bed",       '#', c_dkgray,  3, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(diggable)},
{"fungal tree",      '7', c_dkgray,  0, tr_null, t_null,
	mfb(flammable2)|mfb(noitem)},
{"shallow water",    '~', c_ltblue,  5, tr_null, t_null,
	mfb(transparent)|mfb(liquid)|mfb(swimmable)},
{"deep water",       '~', c_blue,    0, tr_null, t_null,
	mfb(transparent)|mfb(liquid)|mfb(swimmable)},
{"sewage",           '~', c_ltgreen, 6, tr_null, t_null,
	mfb(transparent)|mfb(swimmable)},
{"lava",             '~', c_red,     4, tr_lava, t_null,
	mfb(transparent)|mfb(liquid)},
{"bed",              '#', c_magenta, 5, tr_null, t_null,
        mfb(transparent)|mfb(container)|mfb(flammable2)|mfb(collapses)|
        mfb(deconstruct)|mfb(place_item)},
{"toilet",           '&', c_white,   4, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(l_flammable)|mfb(collapses)},
{"makeshift bed",    '#', c_magenta, 5, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"sink",             '&', c_white,   4, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(l_flammable)|mfb(collapses)|mfb(container)|mfb(place_item)},
{"oven",             '#', c_dkgray,  4, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(l_flammable)|mfb(collapses)|mfb(container)|mfb(place_item)},
{"wood stove",             '#', i_red,   4, tr_null, t_null,
        mfb(transparent)|mfb(container)|mfb(place_item)},
{"bathtub",          '~', c_white,   4, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(l_flammable)|mfb(collapses)|mfb(container)|mfb(place_item)},
{"chair",            '#', c_brown,   2, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"arm chair",            'H', c_green,   3, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"sofa",             'H', i_red,     3, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"cupboard",         '#', c_blue,    3, tr_null, t_null,
        mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)|
        mfb(container)|mfb(place_item)},
{"trash can",        '&', c_ltcyan,  3, tr_null, t_null,
        mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(container)|mfb(place_item)},
{"desk",             '#', c_ltred,   3, tr_null, t_null,
        mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)|
        mfb(container)|mfb(place_item)},
{"sandbox",          '#', c_yellow,  3, tr_null, t_null,
	mfb(transparent)|mfb(deconstruct)},
{"slide",            '#', c_ltcyan,  4, tr_null, t_null,
	mfb(transparent)|mfb(deconstruct)},
{"monkey bars",      '#', c_cyan,    4, tr_null, t_null,
	mfb(transparent)|mfb(deconstruct)},
{"backboard",        '7', c_red,     0, tr_null, t_null,
	mfb(transparent)|mfb(deconstruct)},
{"bench",            '#', c_brown,   3, tr_null, t_null,
	mfb(transparent)|mfb(flammable2)|mfb(collapses)|mfb(deconstruct)},
{"table",            '#', c_red,     4, tr_null, t_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)|mfb(deconstruct)},
{"pool table",       '#', c_green,   4, tr_null, t_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)|mfb(deconstruct)},
{"gasoline pump",    '&', c_red,     0, tr_null, t_null,
	mfb(transparent)|mfb(explodes)|mfb(noitem)},
{"smashed gas pump", '&', c_ltred,   0, tr_null, t_null,
	mfb(transparent)|mfb(noitem)},
{"out-of-order gasoline pump",    '&', c_red,     0, tr_null, t_null,
	mfb(transparent)|mfb(noitem)},
{"missile",          '#', c_ltblue,  0, tr_null, t_null,
	mfb(explodes)|mfb(noitem)},
{"blown-out missile",'#', c_ltgray,  0, tr_null, t_null,
	mfb(noitem)},
{"counter",	     '#', c_blue,    4, tr_null, t_null,
	mfb(transparent)|mfb(flammable)|mfb(collapses)|mfb(deconstruct)},
{"radio tower",      '&', c_ltgray,  0, tr_null, t_null,
	mfb(noitem)},
{"radio controls",   '6', c_green,   0, tr_null, t_null,
	mfb(transparent)|mfb(bashable)|mfb(noitem)},
{"broken console",   '6', c_ltgray,  0, tr_null, t_null,
	mfb(transparent)|mfb(noitem)|mfb(collapses)},
{"computer console", '6', c_blue,    0, tr_null, t_null,
	mfb(transparent)|mfb(console)|mfb(noitem)|mfb(collapses)},
{"mechanical winch", '6', c_cyan_red, 0, tr_null, t_null,
        mfb(transparent)|mfb(noitem)|mfb(collapses)},
{"rope and pulley", '|', i_brown, 0, tr_null, t_null,
        mfb(transparent)|mfb(noitem)|mfb(collapses)},
{"sewage pipe",      '1', c_ltgray,  0, tr_null, t_null,
	mfb(transparent)},
{"sewage pump",      '&', c_ltgray,  0, tr_null, t_null,
	mfb(noitem)},
{"centrifuge",       '{', c_magenta, 0, tr_null, t_null,
	mfb(transparent)},
{"column",           '1', c_ltgray,  0, tr_null, t_null,
	mfb(flammable)},
{"refrigerator",     '{', c_ltcyan,  0, tr_null, t_null,
	mfb(container)|mfb(collapses)|mfb(bashable)|mfb(place_item)},
{"glass door fridge",'{', c_ltcyan,  0, tr_null, t_null,
        mfb(collapses)|mfb(bashable)|mfb(place_item)},
{"dresser",          '{', c_brown,   0, tr_null, t_null,
        mfb(transparent)|mfb(container)|mfb(flammable)|mfb(collapses)|
        mfb(bashable)|mfb(deconstruct)|mfb(place_item)},
{"locker",           '{', c_ltgray,  0, tr_null, t_null,
        mfb(container)|mfb(collapses)|mfb(bashable)|mfb(place_item)},
{"display rack",     '{', c_ltgray,  0, tr_null, t_null,
        mfb(transparent)|mfb(l_flammable)|mfb(collapses)|mfb(bashable)|
        mfb(deconstruct)|mfb(place_item)},
{"book case",        '{', c_brown,   0, tr_null, t_null,
        mfb(flammable)|mfb(collapses)|mfb(bashable)|mfb(deconstruct)|mfb(place_item)},
{"dumpster",	     '{', c_green,   0, tr_null, t_null,
        mfb(container)|mfb(bashable)|mfb(place_item)},
{"cloning vat",      '0', c_ltcyan,  0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(sealed)|mfb(place_item)},
{"crate",            'X', i_brown,   0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(container)|mfb(sealed)|
        mfb(flammable)|mfb(deconstruct)|mfb(place_item)},
{"open crate",       'O', i_brown,   0, tr_null, t_null,
        mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable)|mfb(place_item)},
{"stairs down",      '>', c_yellow,  2, tr_null, t_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"stairs up",        '<', c_yellow,  2, tr_null, t_null,
        mfb(transparent)|mfb(goes_up)|mfb(place_item)},
{"manhole",          '>', c_dkgray,  2, tr_null, t_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"ladder",           '<', c_dkgray,  2, tr_null, t_null,
        mfb(transparent)|mfb(goes_up)|mfb(place_item)},
{"ladder",           '>', c_dkgray,  2, tr_null, t_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"downward slope",   '>', c_brown,   2, tr_null, t_null,
        mfb(transparent)|mfb(goes_down)|mfb(place_item)},
{"upward slope",     '<', c_brown,   2, tr_null, t_null,
        mfb(transparent)|mfb(goes_up)|mfb(place_item)},
{"rope leading up",  '<', c_white,   2, tr_null, t_null,
	mfb(transparent)|mfb(goes_up)},
{"manhole cover",    '0', c_dkgray,  2, tr_null, t_null,
	mfb(transparent)},
{"card reader",	     '6', c_pink,    0, tr_null, t_null,	// Science
	mfb(noitem)},
{"card reader",	     '6', c_pink,    0, tr_null, t_null,	// Military
	mfb(noitem)},
{"broken card reader",'6',c_ltgray,  0, tr_null, t_null,
	mfb(noitem)},
{"slot machine",     '6', c_green,   0, tr_null, t_null,
	mfb(bashable)|mfb(noitem)},
{"elevator controls",'6', c_ltblue,  0, tr_null, t_null,
	mfb(noitem)},
{"powerless controls",'6',c_ltgray,  0, tr_null, t_null,
	mfb(noitem)},
{"elevator",         '.', c_magenta, 2, tr_null, t_null,
	0},
{"dark pedestal",    '&', c_dkgray,  0, tr_null, t_null,
	mfb(transparent)},
{"light pedestal",   '&', c_white,   0, tr_null, t_null,
	mfb(transparent)},
{"red stone",        '#', c_red,     0, tr_null, t_null,
	0},
{"green stone",      '#', c_green,   0, tr_null, t_null,
	0},
{"blue stone",       '#', c_blue,    0, tr_null, t_null,
	0},
{"red floor",        '.', c_red,     2, tr_null, t_null,
	mfb(transparent)},
{"green floor",      '.', c_green,   2, tr_null, t_null,
	mfb(transparent)},
{"blue floor",       '.', c_blue,    2, tr_null, t_null,
	mfb(transparent)},
{"yellow switch",    '6', c_yellow,  0, tr_null, t_null,
	mfb(transparent)},
{"cyan switch",      '6', c_cyan,    0, tr_null, t_null,
	mfb(transparent)},
{"purple switch",    '6', c_magenta, 0, tr_null, t_null,
	mfb(transparent)},
{"checkered switch", '6', c_white,   0, tr_null, t_null,
	mfb(transparent)},
{"mutated poppy flower", 'f', c_red, 3, tr_null, t_null,
        mfb(transparent)}
};
...
struct field_t {
 ...
 bool _volatile; // field is volative and changes feature each redraw (volatile is a C++ keyword, hence the _)
};
...
struct submap {
 ...
 t_feature      feature[SEEX][SEEY]; // Terrain feature (variety of terrain) of each square
